...
class LegendGridJqx extends React.PureComponent<{}, IGridProps> {
    ...
    private getColumns(): IGridProps['columns'] {
        return [
            {text: 'Class Label', datafield: 'label', columntype: 'textbox', width: "30%"},
            {
                text: 'Min Value', datafield: 'min_val', columntype: 'numberinput', width: "20%",
                align: 'center', cellsalign: 'center', cellsformat: 'f',
            ...
            {
                text: 'Max Value', datafield: 'max_val', columntype: 'numberinput', width: "20%",
                align: 'center', cellsalign: 'center', cellsformat: 'f',
                createeditor: (row: number, cellvalue: any, editor: any): void => {
                    editor.jqxNumberInput({digits: 3});
                },
            ...
            {
                text: 'Color', datafield: 'color', columntype: 'custom', width: "30%",
                    ...
                    editorRoot.render(
                        ...
                        <JqxDropDownButton ref={myDropDown} style={{margin: '3px', float: 'left'}}
                            ...
                            <div style={{padding: '3px'}}>
                                <JqxColorPicker onColorchange={(event: any): void => {
                                    const value = '#' + event?.args?.color.hex;
                                    editor[0].style.backgroundColor = '#' + event?.args?.color.hex;
        ...
        return (
            <div style={{padding: "10px"}}>
                <JqxGrid ref={this.myGrid}
                    // @ts-ignore
                         width={600} source={this.state.source}
