...
export const LegendIcons = (props: SymbologyIconProps) => {
    ...
    const handleClick = () => {
        dialogBoxRef.current?.openDialog({
            content: <Paper elevation={4} sx={{p: 2, width: 300}}>
                <VectorSymbolizer ref={vectorStyleRef} geomType={props.geomType}
                                  style={props.style}/></Paper>,
            actions: (<React.Fragment>
                <Button onClick={handleApplyStyle} autoFocus>Apply</Button>
    ...
    const getIcon = (): JSX.Element => {
        const gt = props.geomType?.length == 1 ? props.geomType[0] : "GeometryCollection"
        ...
        switch (gt) {
            ...
            case "MultiLineString":
                return <svg role="img" width="75" height="30" xmlns="http://www.w3.org/2000/svg">
                    <line x1="0" y1="15" x2="75" y2="15"
                          style={{stroke: style?.strokeColor, strokeWidth: style?.strokeWidth}}/>
                </svg>
            default:
                return <svg role="img" width="75" height="30" xmlns="http://www.w3.org/2000/svg">
                    <rect x="0" y="0" width="75" height="28"
                          style={{
