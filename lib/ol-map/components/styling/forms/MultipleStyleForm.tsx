        ...
        return (
            <React.Fragment>
                ...
                <fieldset>
                    ...
                    <Box sx={{flex: 1, pt: 1}}>
                        <Button onClick={this.AddStyleItem.bind(this)}
                                fullWidth={true} color={"success"}
                                variant={"contained"}
                        >Add Value</Button>
                    </Box>
                    <Box sx={{flex: 1, pt: 1}}>
                        <Button onClick={this.AddAllStyleItem.bind(this)}
                                fullWidth={true} color={"primary"}
                                variant={"contained"}
                        >Add All Value</Button>
                    </Box>
                    <Box sx={{flex: 1, pt: 1}}>
                        <Button onClick={this.RemoveAllItems.bind(this)}
                                fullWidth={true} color={"error"}
                                variant={"contained"}
                        >Clear</Button>
                    </Box>
                </fieldset>
